...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link me-lg-3" href="#download">Documentation</a></li>
                    </ul>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-1 lh-1 mb-3">Take Your Business to the Next Level.</h1>
                            <p class="lead fw-normal text-muted mb-5">Start broadcasting and managing your customer service with the help of our bots</p>
                    ...
                    <div class="modal-body border-0 p-4">
                        <form   action="./controller/loginController.php" method="post">
                            ...
                            <!-- <div class="form-floating mb-3">
                             ...
                             <!-- Name input-->
                             <div class="form-floating mb-3">
                                <input class="form-control" id="name" name="password" type="password" placeholder="Enter your name..." data-sb-validations="required" />
                            ...
                            <!-- Submit Button-->
                            <div class="d-grid"><button class="btn btn-primary rounded-pill btn-lg"  name="submit" id="submitButton" type="submit">Login</button></div>
                            <br>
                        </form>
                        <div class="text-center text-primary mb-3">OR!</div>
                            <div class="d-grid"><button class="btn btn-success rounded-pill btn-lg" data-bs-toggle="modal" data-bs-target="#registerkModal">Register</button></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Register Modal-->
        <div class="modal fade" id="registerkModal" tabindex="-1" aria-labelledby="feedbackModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary-to-secondary p-4">
                    ...
                    <div class="modal-body border-0 p-4">
                        <form   action="registerController.php" method="post">
                            ...
                            <div class="d-none" id="submitErrorMessage"><div class="text-center text-danger mb-3">Error sending message!</div></div>
                            <!-- Submit Button-->
                            <div class="d-grid"><button class="btn btn-success rounded-pill btn-lg"  name="submit" id="submitButton" type="submit">Register</button></div>
                        </form>
                    </div>
                </div>
            </div>
